...
//支撑架数据表
const QString constStationInfoTable = QString("\"PD_Station_Info_Table\"");
const QString constStationPasteLabelInfoTable = QString("\"PD_Station_Paste_Label_Info_Table\"");
